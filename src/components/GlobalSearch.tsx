...
interface GlobalSearchProps {
    onNavigate?: (page: string, data?: never) => void;
    placeholder?: string;
    className?: string;
}
...
export function GlobalSearch({
    ...
    const allData: SearchResult[] = [
        ...
        // Pages
        {id: 'page-1', type: 'page', title: 'District Browser', subtitle: 'Explore all 805 districts'},
        {id: 'page-2', type: 'page', title: 'State F&O', subtitle: 'Futures & Options trading'},
        {id: 'page-3', type: 'page', title: 'Mutual Funds', subtitle: 'AI-powered investment funds'},
        {id: 'page-4', type: 'page', title: 'Portfolio', subtitle: 'View your investments'},
        {id: 'page-5', type: 'page', title: 'Market Performance', subtitle: 'Live market data & analytics'},
        {id: 'page-6', type: 'page', title: 'Live Status', subtitle: 'Real-time market updates'},
        {id: 'page-7', type: 'page', title: 'Insights', subtitle: 'AI-powered market insights'},
        {id: 'page-8', type: 'page', title: 'Settings', subtitle: 'Manage your account'},
    ];
    ...
    const handleSelectResult = (result: SearchResult) => {
        ...
        if (onNavigate) {
            switch (result.type) {
                case 'district':
                    onNavigate('district-detail', {district: result.title});
                    break;
                case 'state':
                    onNavigate('state-fno-detail', {state: result.title});
                    break;
                case 'fund':
                ...
                case 'fno':
                    ...
                    break;
                case 'page':
                    onNavigate(result.title.toLowerCase().replace(/\s+/g, '-'));
                    break;
            }
        }
